| 🛑 | **This is a testing-only repository. View the main project repository at https://github.com/hibbitts-design/docsify-open-multicourse-starter-kit.** |
|---|:--|
...
1. Open the `index.html` file for editing.
2. Locate the line `<title>Docsify Open MultiCourse Starter Kit</title>` and change the text between the title tags to your site name
3. Locate the line `name: 'Docsify Open MultiCourse Starter Kit',` and change the text between the quotes to your site name
